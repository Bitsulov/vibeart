...
const LikeButton = ({count, isLiked = false, onClick = () => {}, ...props}) => {
	...
	return (
		<button className={classes.likeButton} onClick={e => likeHandler(e, setCountInner, isLikedInner, setIsLikedInner, onClick)} {...props}>
			<svg className={isLikedInner ? `${classes.likeImg} ${classes.likeActive}` : classes.likeImg}
