...
import { slideRight } from "../model/clickHandlers.js";
import type Swiper from "swiper";

interface AlbumListButtonRightProps {
    swiperRef: React.RefObject<Swiper | null>;
}

const AlbumListButtonRight = forwardRef(
    ({ swiperRef, ...props }: AlbumListButtonRightProps, ref: React.ForwardedRef<HTMLButtonElement>) => {
        return (
            <button ref={ref} onClick={e => slideRight(e, swiperRef)} {...props}>
                <svg
